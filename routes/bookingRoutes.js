...
// Create booking (User/Admin/SuperAdmin)
router.post('/', authMiddleware(['user', 'admin', 'superadmin']), bookingController.createBooking);
...
// Update booking (Admin/SuperAdmin only)
router.put('/:id', authMiddleware(['admin', 'superadmin']), bookingController.updateBooking);
